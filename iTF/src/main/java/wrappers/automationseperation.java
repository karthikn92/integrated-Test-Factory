...
public class automationseperation {
	...
	//	System.out.println(noofRows);
		...
		//	System.out.println(sheet.getRow(a.get(i)).getCell(testcaseIDcol).getNumericCellValue());
		}
		}
		}catch(Exception e){
...
//						XSSFRow aurow=automationsheet.createRow(x);
//						XSSFRow mrow=manualsheet.createRow(x);
//						
//						XSSFCell au=aurow.createCell(p);
//						XSSFCell m=mrow.createCell(p);
//						
//						au.setCellValue(sheet.getRow(x).getCell(p).getStringCellValue());
//						m.setCellValue(sheet.getRow(x).getCell(p).getStringCellValue());
...
//				        		 	XSSFRow automationrow=automationsheet.createRow(count);
//				        		 	XSSFCell automationcell=automationrow.createCell(z);
//				        		 	automationcell.setCellValue(sheet.getRow(y+1).getCell(z).getStringCellValue());
...
//				        		 XSSFRow manualrow=manualsheet.createRow(manual_count);
//				        		 XSSFCell manualcell= manualrow.createCell(z);
//				        		 manualcell.setCellValue(sheet.getRow(y+1).getCell(z).getStringCellValue());
